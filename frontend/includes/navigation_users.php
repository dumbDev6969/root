...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <?php
    if (isset($_SESSION['userData']) && isset($_SESSION['userData']['user_uuid'])) {
        $user_uuid = $_SESSION['userData']['user_uuid'];
        echo "console.log('User UUID:', '" . $user_uuid . "');";

        // Initialize chat directly without setTimeout
        echo "
        if (typeof connectWebSocket === 'function') {
            connectWebSocket('" . $user_uuid . "', '" . getWebSocketURL() . "');
        } else {
        ...
        echo "alert('Error: No user UUID found in session. Please check if you are properly logged in.');";
    }
